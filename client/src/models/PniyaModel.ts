 ...
 * 
 * @export
 * @interface PniyaModel
 */
export interface PniyaModel {
    /**
     * 
     * @type {string}
     * @memberof PniyaModel
...
/**
 * Check if a given object implements the PniyaModel interface.
 */
export function instanceOfPniyaModel(value: object): value is PniyaModel {
    return true;
}

export function PniyaModelFromJSON(json: any): PniyaModel {
    return PniyaModelFromJSONTyped(json, false);
}

export function PniyaModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): PniyaModel {
    if (json == null) {
        return json;
    }
    return {
        ...
        'pniya': json['pniya'] == null ? undefined : json['pniya'],
    };
}

export function PniyaModelToJSON(json: any): PniyaModel {
    return PniyaModelToJSONTyped(json, false);
}

export function PniyaModelToJSONTyped(value?: PniyaModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
