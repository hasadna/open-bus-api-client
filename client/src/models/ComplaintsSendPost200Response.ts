 ...
 * 
 * @export
 * @interface ComplaintsSendPost200Response
 */
export interface ComplaintsSendPost200Response {
    /**
     * 
     * @type {boolean}
     * @memberof ComplaintsSendPost200Response
     */
    success?: boolean;
    /**
     * 
    ...
    debug?: boolean;
    /**
     * Generated XML (only in debug mode)
     * @type {string}
     * @memberof ComplaintsSendPost200Response
     */
    xml?: string;
    /**
     * Response data from the government forms system
     * @type {object}
     * @memberof ComplaintsSendPost200Response
     */
    data?: object;
...
/**
 * Check if a given object implements the ComplaintsSendPost200Response interface.
 */
export function instanceOfComplaintsSendPost200Response(value: object): value is ComplaintsSendPost200Response {
    return true;
}

export function ComplaintsSendPost200ResponseFromJSON(json: any): ComplaintsSendPost200Response {
    return ComplaintsSendPost200ResponseFromJSONTyped(json, false);
}

export function ComplaintsSendPost200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComplaintsSendPost200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'xml': json['xml'] == null ? undefined : json['xml'],
        'data': json['data'] == null ? undefined : json['data'],
        'referenceNumber': json['referenceNumber'] == null ? undefined : json['referenceNumber'],
    };
}

export function ComplaintsSendPost200ResponseToJSON(json: any): ComplaintsSendPost200Response {
    return ComplaintsSendPost200ResponseToJSONTyped(json, false);
}

export function ComplaintsSendPost200ResponseToJSONTyped(value?: ComplaintsSendPost200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
