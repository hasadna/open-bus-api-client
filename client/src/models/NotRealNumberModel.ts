 ...
 * 
 * @export
 * @interface NotRealNumberModel
 */
export interface NotRealNumberModel {
    /**
     * 
     * @type {string}
     * @memberof NotRealNumberModel
     */
    rowNumber?: string;
    /**
     * 
...
/**
 * Check if a given object implements the NotRealNumberModel interface.
 */
export function instanceOfNotRealNumberModel(value: object): value is NotRealNumberModel {
    return true;
}

export function NotRealNumberModelFromJSON(json: any): NotRealNumberModel {
    return NotRealNumberModelFromJSONTyped(json, false);
}

export function NotRealNumberModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): NotRealNumberModel {
    if (json == null) {
        return json;
    }
    return {
        ...
        'idNum': json['IdNum'] == null ? undefined : json['IdNum'],
    };
}

export function NotRealNumberModelToJSON(json: any): NotRealNumberModel {
    return NotRealNumberModelToJSONTyped(json, false);
}

export function NotRealNumberModelToJSONTyped(value?: NotRealNumberModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
