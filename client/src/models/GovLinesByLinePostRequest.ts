 ...
 * 
 * @export
 * @interface GovLinesByLinePostRequest
 */
export interface GovLinesByLinePostRequest {
    /**
     * Event date in number format (e.g., new Date('2025-05-13T00:00:00').getTime())
     * @type {number}
     * @memberof GovLinesByLinePostRequest
     */
    eventDate: number;
    /**
...
/**
 * Check if a given object implements the GovLinesByLinePostRequest interface.
 */
export function instanceOfGovLinesByLinePostRequest(value: object): value is GovLinesByLinePostRequest {
    ...
    if (!('operatorLineId' in value) || value['operatorLineId'] === undefined) return false;
    return true;
}

export function GovLinesByLinePostRequestFromJSON(json: any): GovLinesByLinePostRequest {
    return GovLinesByLinePostRequestFromJSONTyped(json, false);
}

export function GovLinesByLinePostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GovLinesByLinePostRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'operatorLineId': json['OperatorLineId'],
    };
}

export function GovLinesByLinePostRequestToJSON(json: any): GovLinesByLinePostRequest {
    return GovLinesByLinePostRequestToJSONTyped(json, false);
}

export function GovLinesByLinePostRequestToJSONTyped(value?: GovLinesByLinePostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'OperatorLineId': value['operatorLineId'],
    };
}
