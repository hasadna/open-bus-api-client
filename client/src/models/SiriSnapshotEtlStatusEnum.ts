...
export function instanceOfSiriSnapshotEtlStatusEnum(value: any): boolean {
    for (const key in SiriSnapshotEtlStatusEnum) {
        if (Object.prototype.hasOwnProperty.call(SiriSnapshotEtlStatusEnum, key)) {
            if (SiriSnapshotEtlStatusEnum[key as keyof typeof SiriSnapshotEtlStatusEnum] === value) {
                return true;
            }
        }
    }
...
export function SiriSnapshotEtlStatusEnumToJSONTyped(value: any, ignoreDiscriminator: boolean): SiriSnapshotEtlStatusEnum {
    return value as SiriSnapshotEtlStatusEnum;
}
