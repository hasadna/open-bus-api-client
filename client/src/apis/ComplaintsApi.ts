...
import type {
  ComplaintsSendPost200Response,
  ComplaintsSendPostRequest,
  ErrorResponseModel,
} from '../models/index';
import {
    ComplaintsSendPost200ResponseFromJSON,
    ComplaintsSendPost200ResponseToJSON,
    ComplaintsSendPostRequestFromJSON,
    ComplaintsSendPostRequestToJSON,
    ErrorResponseModelFromJSON,
    ErrorResponseModelToJSON,
} from '../models/index';

export interface ComplaintsSendPostOperationRequest {
    complaintsSendPostRequest?: ComplaintsSendPostRequest;
}
...
export class ComplaintsApi extends runtime.BaseAPI {
    ...
    /**
     * Submits a complaint to the government forms system
     * Send a complaint
     */
    async complaintsSendPostRaw(requestParameters: ComplaintsSendPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ComplaintsSendPost200Response>> {
        ...
        const response = await this.request({
            ...
            body: ComplaintsSendPostRequestToJSON(requestParameters['complaintsSendPostRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ComplaintsSendPost200ResponseFromJSON(jsonValue));
    }
     ...
     * Send a complaint
     */
    async complaintsSendPost(requestParameters: ComplaintsSendPostOperationRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ComplaintsSendPost200Response> {
        const response = await this.complaintsSendPostRaw(requestParameters, initOverrides);
