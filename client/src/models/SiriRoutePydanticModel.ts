 ...
 */
export function instanceOfSiriRoutePydanticModel(value: object): value is SiriRoutePydanticModel {
...
export function SiriRoutePydanticModelToJSON(json: any): SiriRoutePydanticModel {
    return SiriRoutePydanticModelToJSONTyped(json, false);
}

export function SiriRoutePydanticModelToJSONTyped(value?: SiriRoutePydanticModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
