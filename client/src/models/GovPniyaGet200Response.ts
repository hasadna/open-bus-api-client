...
import type { PniyaModel } from './PniyaModel';
import {
    PniyaModelFromJSON,
    PniyaModelFromJSONTyped,
    PniyaModelToJSON,
    PniyaModelToJSONTyped,
} from './PniyaModel';

/**
 * 
 * @export
 * @interface GovPniyaGet200Response
 */
export interface GovPniyaGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof GovPniyaGet200Response
     */
    success?: boolean;
    /**
     * 
     * @type {Array<PniyaModel>}
     * @memberof GovPniyaGet200Response
     */
    data?: Array<PniyaModel>;
}

/**
 * Check if a given object implements the GovPniyaGet200Response interface.
 */
export function instanceOfGovPniyaGet200Response(value: object): value is GovPniyaGet200Response {
    return true;
}

export function GovPniyaGet200ResponseFromJSON(json: any): GovPniyaGet200Response {
    return GovPniyaGet200ResponseFromJSONTyped(json, false);
}

export function GovPniyaGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GovPniyaGet200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(PniyaModelFromJSON)),
    };
}

export function GovPniyaGet200ResponseToJSON(json: any): GovPniyaGet200Response {
    return GovPniyaGet200ResponseToJSONTyped(json, false);
}

export function GovPniyaGet200ResponseToJSONTyped(value?: GovPniyaGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(PniyaModelToJSON)),
    };
}
