 ...
 */
export function instanceOfGtfsAgencyPydanticModel(value: object): value is GtfsAgencyPydanticModel {
...
export function GtfsAgencyPydanticModelToJSON(json: any): GtfsAgencyPydanticModel {
    return GtfsAgencyPydanticModelToJSONTyped(json, false);
}

export function GtfsAgencyPydanticModelToJSONTyped(value?: GtfsAgencyPydanticModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
