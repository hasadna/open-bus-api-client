...
/**
 * Check if a given object implements the StationModel interface.
 */
export function instanceOfStationModel(value: object): value is StationModel {
    return true;
}

export function StationModelFromJSON(json: any): StationModel {
    return StationModelFromJSONTyped(json, false);
}

export function StationModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): StationModel {
    if (json == null) {
        return json;
    }
    return {
        
        'stationId': json['stationId'] == null ? undefined : json['stationId'],
        ...
        'stationFullName': json['stationFullName'] == null ? undefined : json['stationFullName'],
    };
}

export function StationModelToJSON(json: any): StationModel {
    return StationModelToJSONTyped(json, false);
}

export function StationModelToJSONTyped(value?: StationModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'stationFullName': value['stationFullName'],
    };
}
