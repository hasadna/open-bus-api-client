...
import type { SubjectModel } from './SubjectModel';
import {
    SubjectModelFromJSON,
    SubjectModelFromJSONTyped,
    SubjectModelToJSON,
    SubjectModelToJSONTyped,
} from './SubjectModel';

/**
 * 
 * @export
 * @interface GovSubjectsGet200Response
 */
export interface GovSubjectsGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof GovSubjectsGet200Response
     */
    success?: boolean;
    /**
     * 
     * @type {Array<SubjectModel>}
     * @memberof GovSubjectsGet200Response
     */
    data?: Array<SubjectModel>;
}

/**
 * Check if a given object implements the GovSubjectsGet200Response interface.
 */
export function instanceOfGovSubjectsGet200Response(value: object): value is GovSubjectsGet200Response {
    return true;
}

export function GovSubjectsGet200ResponseFromJSON(json: any): GovSubjectsGet200Response {
    return GovSubjectsGet200ResponseFromJSONTyped(json, false);
}

export function GovSubjectsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GovSubjectsGet200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(SubjectModelFromJSON)),
    };
}

export function GovSubjectsGet200ResponseToJSON(json: any): GovSubjectsGet200Response {
    return GovSubjectsGet200ResponseToJSONTyped(json, false);
}

export function GovSubjectsGet200ResponseToJSONTyped(value?: GovSubjectsGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(SubjectModelToJSON)),
    };
}
