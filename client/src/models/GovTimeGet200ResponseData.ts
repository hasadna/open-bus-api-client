 ...
 * 
 * @export
 * @interface GovTimeGet200ResponseData
 */
export interface GovTimeGet200ResponseData {
    /**
     * 
     * @type {string}
     * @memberof GovTimeGet200ResponseData
     */
    serverTime?: string;
}

/**
 * Check if a given object implements the GovTimeGet200ResponseData interface.
 */
export function instanceOfGovTimeGet200ResponseData(value: object): value is GovTimeGet200ResponseData {
    return true;
}

export function GovTimeGet200ResponseDataFromJSON(json: any): GovTimeGet200ResponseData {
    return GovTimeGet200ResponseDataFromJSONTyped(json, false);
}

export function GovTimeGet200ResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): GovTimeGet200ResponseData {
    if (json == null) {
        return json;
    }
    return {
...
export function GovTimeGet200ResponseDataToJSON(json: any): GovTimeGet200ResponseData {
    return GovTimeGet200ResponseDataToJSONTyped(json, false);
}

export function GovTimeGet200ResponseDataToJSONTyped(value?: GovTimeGet200ResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
