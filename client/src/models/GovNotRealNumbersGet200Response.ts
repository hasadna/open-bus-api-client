...
import type { NotRealNumberModel } from './NotRealNumberModel';
import {
    NotRealNumberModelFromJSON,
    NotRealNumberModelFromJSONTyped,
    NotRealNumberModelToJSON,
    NotRealNumberModelToJSONTyped,
} from './NotRealNumberModel';

/**
 * 
 * @export
 * @interface GovNotRealNumbersGet200Response
 */
export interface GovNotRealNumbersGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof GovNotRealNumbersGet200Response
     */
    success?: boolean;
    /**
     * 
     * @type {Array<NotRealNumberModel>}
     * @memberof GovNotRealNumbersGet200Response
     */
    data?: Array<NotRealNumberModel>;
}

/**
 * Check if a given object implements the GovNotRealNumbersGet200Response interface.
 */
export function instanceOfGovNotRealNumbersGet200Response(value: object): value is GovNotRealNumbersGet200Response {
    return true;
}

export function GovNotRealNumbersGet200ResponseFromJSON(json: any): GovNotRealNumbersGet200Response {
    return GovNotRealNumbersGet200ResponseFromJSONTyped(json, false);
}

export function GovNotRealNumbersGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GovNotRealNumbersGet200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(NotRealNumberModelFromJSON)),
    };
}

export function GovNotRealNumbersGet200ResponseToJSON(json: any): GovNotRealNumbersGet200Response {
    return GovNotRealNumbersGet200ResponseToJSONTyped(json, false);
}

export function GovNotRealNumbersGet200ResponseToJSONTyped(value?: GovNotRealNumbersGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(NotRealNumberModelToJSON)),
    };
}
