 ...
 * 
 * @export
 * @interface GovCitiesGet200Response
 */
export interface GovCitiesGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof GovCitiesGet200Response
     */
    success?: boolean;
    /**
     * 
     * @type {Array<CityModel>}
     * @memberof GovCitiesGet200Response
     */
...
/**
 * Check if a given object implements the GovCitiesGet200Response interface.
 */
export function instanceOfGovCitiesGet200Response(value: object): value is GovCitiesGet200Response {
    return true;
}

export function GovCitiesGet200ResponseFromJSON(json: any): GovCitiesGet200Response {
    return GovCitiesGet200ResponseFromJSONTyped(json, false);
}

export function GovCitiesGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GovCitiesGet200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(CityModelFromJSON)),
    };
}

export function GovCitiesGet200ResponseToJSON(json: any): GovCitiesGet200Response {
    return GovCitiesGet200ResponseToJSONTyped(json, false);
}

export function GovCitiesGet200ResponseToJSONTyped(value?: GovCitiesGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(CityModelToJSON)),
    };
}
