 ...
 */
export function instanceOfGtfsRideWithRelatedPydanticModel(value: object): value is GtfsRideWithRelatedPydanticModel {
    return true;
}
...
export function GtfsRideWithRelatedPydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): GtfsRideWithRelatedPydanticModel {
    ...
    return {
        ...
        'gtfsRouteId': json['gtfs_route_id'] == null ? undefined : json['gtfs_route_id'],
...
export function GtfsRideWithRelatedPydanticModelToJSON(json: any): GtfsRideWithRelatedPydanticModel {
    return GtfsRideWithRelatedPydanticModelToJSONTyped(json, false);
}

export function GtfsRideWithRelatedPydanticModelToJSONTyped(value?: GtfsRideWithRelatedPydanticModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
