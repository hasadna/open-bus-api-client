 ...
 * 
 * @export
 * @interface GovTrainStationsPostRequest
 */
export interface GovTrainStationsPostRequest {
    /**
     * Station type ID (e.g., 7 for Israel Train)
     * @type {number}
     * @memberof GovTrainStationsPostRequest
     */
    stationTypeId: number;
}

/**
 * Check if a given object implements the GovTrainStationsPostRequest interface.
 */
export function instanceOfGovTrainStationsPostRequest(value: object): value is GovTrainStationsPostRequest {
    if (!('stationTypeId' in value) || value['stationTypeId'] === undefined) return false;
    return true;
}

export function GovTrainStationsPostRequestFromJSON(json: any): GovTrainStationsPostRequest {
    return GovTrainStationsPostRequestFromJSONTyped(json, false);
}

export function GovTrainStationsPostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GovTrainStationsPostRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function GovTrainStationsPostRequestToJSON(json: any): GovTrainStationsPostRequest {
    return GovTrainStationsPostRequestToJSONTyped(json, false);
}

export function GovTrainStationsPostRequestToJSONTyped(value?: GovTrainStationsPostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
