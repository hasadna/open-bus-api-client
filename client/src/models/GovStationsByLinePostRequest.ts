 ...
 * 
 * @export
 * @interface GovStationsByLinePostRequest
 */
export interface GovStationsByLinePostRequest {
    /**
     * Event date in number format (e.g., new Date('2025-05-13T00:00:00').getTime())
     * @type {number}
     * @memberof GovStationsByLinePostRequest
     */
    eventDate: number;
    /**
    ...
    operatorId: number;
    /**
     * Official line ID (e.g., 12083)
     * @type {number}
     * @memberof GovStationsByLinePostRequest
     */
    officelineId: number;
    /**
     * Direction code (e.g., 1)
     * @type {number}
     * @memberof GovStationsByLinePostRequest
     */
    directions: number;
...
/**
 * Check if a given object implements the GovStationsByLinePostRequest interface.
 */
export function instanceOfGovStationsByLinePostRequest(value: object): value is GovStationsByLinePostRequest {
    ...
    if (!('officelineId' in value) || value['officelineId'] === undefined) return false;
    if (!('directions' in value) || value['directions'] === undefined) return false;
    return true;
}

export function GovStationsByLinePostRequestFromJSON(json: any): GovStationsByLinePostRequest {
    return GovStationsByLinePostRequestFromJSONTyped(json, false);
}

export function GovStationsByLinePostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GovStationsByLinePostRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'officelineId': json['OfficelineId'],
        'directions': json['Directions'],
    };
}

export function GovStationsByLinePostRequestToJSON(json: any): GovStationsByLinePostRequest {
    return GovStationsByLinePostRequestToJSONTyped(json, false);
}

export function GovStationsByLinePostRequestToJSONTyped(value?: GovStationsByLinePostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'OfficelineId': value['officelineId'],
