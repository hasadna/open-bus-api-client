...
/**
 * Check if a given object implements the RideExecutionPydanticModel interface.
 */
export function instanceOfRideExecutionPydanticModel(value: object): value is RideExecutionPydanticModel {
    return true;
}

export function RideExecutionPydanticModelFromJSON(json: any): RideExecutionPydanticModel {
    return RideExecutionPydanticModelFromJSONTyped(json, false);
}

export function RideExecutionPydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): RideExecutionPydanticModel {
    if (json == null) {
        return json;
    }
    return {
        
        'plannedStartTime': json['planned_start_time'] == null ? undefined : (new Date(json['planned_start_time'])),
...
export function RideExecutionPydanticModelToJSON(json: any): RideExecutionPydanticModel {
    return RideExecutionPydanticModelToJSONTyped(json, false);
}

export function RideExecutionPydanticModelToJSONTyped(value?: RideExecutionPydanticModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'planned_start_time': value['plannedStartTime'] == null ? undefined : ((value['plannedStartTime']).toISOString()),
