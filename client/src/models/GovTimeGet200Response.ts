...
import type { GovTimeGet200ResponseData } from './GovTimeGet200ResponseData';
import {
    GovTimeGet200ResponseDataFromJSON,
    GovTimeGet200ResponseDataFromJSONTyped,
    GovTimeGet200ResponseDataToJSON,
    GovTimeGet200ResponseDataToJSONTyped,
} from './GovTimeGet200ResponseData';

/**
 * 
 * @export
 * @interface GovTimeGet200Response
 */
export interface GovTimeGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof GovTimeGet200Response
     */
    success?: boolean;
    /**
     * 
     * @type {GovTimeGet200ResponseData}
     * @memberof GovTimeGet200Response
     */
    data?: GovTimeGet200ResponseData;
}

/**
 * Check if a given object implements the GovTimeGet200Response interface.
 */
export function instanceOfGovTimeGet200Response(value: object): value is GovTimeGet200Response {
    return true;
}

export function GovTimeGet200ResponseFromJSON(json: any): GovTimeGet200Response {
    return GovTimeGet200ResponseFromJSONTyped(json, false);
}

export function GovTimeGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GovTimeGet200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : GovTimeGet200ResponseDataFromJSON(json['data']),
    };
}

export function GovTimeGet200ResponseToJSON(json: any): GovTimeGet200Response {
    return GovTimeGet200ResponseToJSONTyped(json, false);
}

export function GovTimeGet200ResponseToJSONTyped(value?: GovTimeGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': GovTimeGet200ResponseDataToJSON(value['data']),
    };
}
