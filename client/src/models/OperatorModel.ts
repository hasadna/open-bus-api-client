...
/**
 * Check if a given object implements the OperatorModel interface.
 */
export function instanceOfOperatorModel(value: object): value is OperatorModel {
    return true;
}
...
export function OperatorModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): OperatorModel {
    ...
    return {
        ...
        'dataCode': json['DataCode'] == null ? undefined : json['DataCode'],
        'dataText': json['DataText'] == null ? undefined : json['DataText'],
    };
}

export function OperatorModelToJSON(json: any): OperatorModel {
    return OperatorModelToJSONTyped(json, false);
}

export function OperatorModelToJSONTyped(value?: OperatorModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
