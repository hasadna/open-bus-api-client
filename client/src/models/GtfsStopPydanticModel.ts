 ...
 */
export function instanceOfGtfsStopPydanticModel(value: object): value is GtfsStopPydanticModel {
...
export function GtfsStopPydanticModelToJSON(json: any): GtfsStopPydanticModel {
    return GtfsStopPydanticModelToJSONTyped(json, false);
}

export function GtfsStopPydanticModelToJSONTyped(value?: GtfsStopPydanticModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
