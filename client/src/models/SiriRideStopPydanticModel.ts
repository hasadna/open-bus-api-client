 ...
 */
export function instanceOfSiriRideStopPydanticModel(value: object): value is SiriRideStopPydanticModel {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('siriStopId' in value) || value['siriStopId'] === undefined) return false;
    if (!('siriRideId' in value) || value['siriRideId'] === undefined) return false;
...
export function SiriRideStopPydanticModelToJSON(json: any): SiriRideStopPydanticModel {
    return SiriRideStopPydanticModelToJSONTyped(json, false);
}

export function SiriRideStopPydanticModelToJSONTyped(value?: SiriRideStopPydanticModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
