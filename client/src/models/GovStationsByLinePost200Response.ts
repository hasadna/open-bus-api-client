...
import {
    StationModelFromJSON,
    StationModelFromJSONTyped,
    StationModelToJSON,
    StationModelToJSONTyped,
} from './StationModel';

/**
 * 
 * @export
 * @interface GovStationsByLinePost200Response
 */
export interface GovStationsByLinePost200Response {
    /**
     * 
     * @type {boolean}
     * @memberof GovStationsByLinePost200Response
     */
    success?: boolean;
    /**
     * 
     * @type {Array<StationModel>}
     * @memberof GovStationsByLinePost200Response
     */
    data?: Array<StationModel>;
}

/**
 * Check if a given object implements the GovStationsByLinePost200Response interface.
 */
export function instanceOfGovStationsByLinePost200Response(value: object): value is GovStationsByLinePost200Response {
    return true;
}

export function GovStationsByLinePost200ResponseFromJSON(json: any): GovStationsByLinePost200Response {
    return GovStationsByLinePost200ResponseFromJSONTyped(json, false);
}

export function GovStationsByLinePost200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GovStationsByLinePost200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(StationModelFromJSON)),
    };
}

export function GovStationsByLinePost200ResponseToJSON(json: any): GovStationsByLinePost200Response {
    return GovStationsByLinePost200ResponseToJSONTyped(json, false);
}

export function GovStationsByLinePost200ResponseToJSONTyped(value?: GovStationsByLinePost200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(StationModelToJSON)),
    };
}
