...
import type { LineModel } from './LineModel';
import {
    LineModelFromJSON,
    LineModelFromJSONTyped,
    LineModelToJSON,
    LineModelToJSONTyped,
} from './LineModel';

/**
 * 
 * @export
 * @interface GovLinesByStationPost200Response
 */
export interface GovLinesByStationPost200Response {
    /**
     * 
     * @type {boolean}
     * @memberof GovLinesByStationPost200Response
     */
    success?: boolean;
    /**
     * 
     * @type {Array<LineModel>}
     * @memberof GovLinesByStationPost200Response
     */
...
/**
 * Check if a given object implements the GovLinesByStationPost200Response interface.
 */
export function instanceOfGovLinesByStationPost200Response(value: object): value is GovLinesByStationPost200Response {
    return true;
}

export function GovLinesByStationPost200ResponseFromJSON(json: any): GovLinesByStationPost200Response {
    return GovLinesByStationPost200ResponseFromJSONTyped(json, false);
}

export function GovLinesByStationPost200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GovLinesByStationPost200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(LineModelFromJSON)),
    };
}

export function GovLinesByStationPost200ResponseToJSON(json: any): GovLinesByStationPost200Response {
    return GovLinesByStationPost200ResponseToJSONTyped(json, false);
}

export function GovLinesByStationPost200ResponseToJSONTyped(value?: GovLinesByStationPost200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(LineModelToJSON)),
    };
}
