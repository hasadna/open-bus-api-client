 ...
 */
export function instanceOfStopArrivalPydanticModel(value: object): value is StopArrivalPydanticModel {
    return true;
}
...
export function StopArrivalPydanticModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): StopArrivalPydanticModel {
    ...
    return {
        ...
        'actualArrivalTime': json['actual_arrival_time'] == null ? undefined : (new Date(json['actual_arrival_time'])),
    };
}

export function StopArrivalPydanticModelToJSON(json: any): StopArrivalPydanticModel {
    return StopArrivalPydanticModelToJSONTyped(json, false);
}

export function StopArrivalPydanticModelToJSONTyped(value?: StopArrivalPydanticModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'actual_arrival_time': value['actualArrivalTime'] == null ? undefined : ((value['actualArrivalTime']).toISOString()),
    };
}
